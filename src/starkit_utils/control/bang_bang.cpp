...
{
BangBang::BangBang(double max_vel_, double max_acc_) : max_vel(max_vel_), max_acc(max_acc_)
{
}

double BangBang::getTime(const Eigen::VectorXd& src, const Eigen::VectorXd& dst) const
{
...
Eigen::VectorXd BangBang::getPosition(const Eigen::VectorXd& src, const Eigen::VectorXd& dst, double elapsed_time) const
{
...
bool BangBang::reachFullSpeed(const Eigen::VectorXd& src, const Eigen::VectorXd& dst) const
{
